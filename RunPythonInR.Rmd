...
```{python}
url = "https://raw.githubusercontent.com/stevenkhwun/PS4DS/main/four_sessions.csv"
sessions = pd.read_csv(url)
sessions
```

```{python}
sp500 = "https://raw.githubusercontent.com/stevenkhwun/PS4DS/main/sp500_data.csv.gz"
